...
Original file is located at
    https://colab.research.google.com/drive/18bA3pR35ntw5CL-IB-zT_JMvCtMoAFEy
...
g.namespace_manager.bind('schema', sc, override=False)

g.add((ns.JaneSmithers, sc.email, Literal("jane.smithers@example.com")))
g.add((ns.JaneSmithers, sc.name, Literal("Jane Smithers")))
...
g.namespace_manager.bind('example', ex, override=False)
g.add((UPM,RDF.type,ns.University))
g.add((ns.JohnSmith,ex.worksFor,UPM))
...
g.add((JohnSmith, FOAF.knows, JaneSmithers))
# Visualize the results
for s, p, o in g:
  print(s,p,o)