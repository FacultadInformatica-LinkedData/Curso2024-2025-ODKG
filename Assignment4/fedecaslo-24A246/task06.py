...
Original file is located at
    https://colab.research.google.com/drive/1QZTepqmZVwyjfdgoTUJ7hlsXup9E18dR
...
g.add((ns.JaneSmith, schema.email, Literal("jsmithers@example.org")))
...
g.add((ex.UPM, RDF.type, ns.University)) # is it necessary to add UPM as a university?
...
# Visualize the results
## See the people John knows to check he knows Jane
knows = g.triples((ns.JohnSmith, FOAF.knows, None))
for s,p,o in knows:
    knowns = g.value(subject=o, predicate=schema.givenName, object=None)
    print(s, knowns)