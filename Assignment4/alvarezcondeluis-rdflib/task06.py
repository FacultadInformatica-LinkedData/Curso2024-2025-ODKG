...
Original file is located at
    https://colab.research.google.com/drive/1XBrb5ffTE4TcvZyITl5yqEhwp10KrpWm
...
g.add((jane, schema.email, Literal("jane.smithers@example.org")))
...
john = ns.JohnSmith
g.add((john, example.worksAt, ns.UPM))
# Visualize the results
for s, p, o in g:
    print(s, p, o)
