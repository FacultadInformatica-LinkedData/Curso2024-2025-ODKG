...
Original file is located at
    https://colab.research.google.com/drive/1i8GBuHPbOIZPF5ZbvyRrLNwiTbT1b3Bh
...
# TO DO
shema2 = Namespace("https://example.org/")
g.add((shema2.UPM, RDF.type, ns.University))
g.add((ns.JohnSmith, schema.worksFor, shema2.UPM))
...
# TO DO
shema3 = Namespace("http://xmlns.com/foaf/0.1/")
g.add((ns.JohnSmith, shema3.knows, ns.JaneSmithers))
