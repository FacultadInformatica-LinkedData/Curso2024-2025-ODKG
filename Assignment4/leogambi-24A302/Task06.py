...
#since there is not any "fullName" property in https://schema.org in am using "name"
g.add((ns.JaneSmithers, SDO.email, Literal("jane.smithers@example.com")))
g.add((ns.JaneSmithers, SDO.name, Literal("Jane Smithers")))
...
#  
# TO DO
g.add((ns.JohnSmith, SDO.worksFor, Literal("UPM")))
# Visualize the results
for s, p, o in g:
  print(s,p,o)
